...
| --------------- | --------------------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------- |
| Cobalt workshop | Blue #2456d8, pale gray #f7f9fc, white, ink #182331 | Arial/system sans           | Split introduction and workspace preview; clear B2B default                         |
| Quiet studio    | Graphite #34383d, white, light gray #f2f3f4         | Arial/system sans           | Centered headline and wide product canvas; studios and focused tools                |
| Signal room     | Navy #152239, blue #7cafff, light text #eef3fb      | Arial/system sans           | Compact two-column introduction and dense app rows; technical products              |
